...
func Walk(stmts []ast.Stmt, f WalkFunc) error {
	return WalkHelper(stmts, f, 0)
}

func WalkHelper(stmts []ast.Stmt, f WalkFunc, deep int) error {
...
func walkStmt(stmt ast.Stmt, f WalkFunc, deep int) error {
	...
	case *ast.IfStmt:
		...
		if err := WalkHelper(stmt.ElseIf, f, deep); err != nil {
			return err
		}
	...
	case *ast.LoopStmt:
		...
		if err := WalkHelper(stmt.Stmts, f, deep); err != nil {
			return err
		}
	case *ast.ForStmt:
	...
	case *ast.SwitchStmt:
		...
		for _, switchCaseStmt := range body.Cases {
			...
			if err := WalkHelper(caseStmt.Stmts, f, deep); err != nil {
				return err
			}
		}
		if err := WalkHelper(body.Default, f, deep); err != nil {
			return err
		}
...
func walkExpr(expr ast.Expr, f WalkFunc, deep int) error {
	...
	case *ast.FuncExpr:
		return WalkHelper(expr.Stmts, f, deep)
	case *ast.AssocExpr:
