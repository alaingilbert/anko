...
func TestFunctions(t *testing.T) {
	_ = os.Setenv("ANKO_DEBUG", "1")
	tests := []Test{
		{Script: `a()`, Input: map[string]any{"a": reflect.Value{}}, RunError: fmt.Errorf("cannot call type reflect.Value"), Name: ""},
		{Script: `a = nil; a()`, RunError: fmt.Errorf("cannot call type interface {}"), Output: map[string]any{"a": nil}, Name: ""},
		{Script: `a = true; a()`, RunError: fmt.Errorf("cannot call type bool"), Output: map[string]any{"a": true}, Name: ""},
		{Script: `a = nil; b = func c(d) { return d == nil }; c = nil; c(a)`, RunError: fmt.Errorf("cannot call type interface {}"), Output: map[string]any{"a": nil}, Name: ""},
		...
		{Script: `a = 1; b = func(,a){}; a`, ParseError: fmt.Errorf("unexpected ','"), Name: ""},
		...
		{Script: `func a(b, c) { }; a()`, RunError: fmt.Errorf("function wants 2 arguments but received 0"), Name: ""},
		{Script: `func a(b, c) { }; a(true)`, RunError: fmt.Errorf("function wants 2 arguments but received 1"), Name: ""},
		{Script: `func a(b, c) { }; a(true, true, true)`, RunError: fmt.Errorf("function wants 2 arguments but received 3"), Name: ""},

		{Script: `func a() { return "a" }; a.b()`, RunError: fmt.Errorf("type func does not support member operation"), Name: ""},
		{Script: `a = [func () { return nil}]; func b(c) { return c() }; b(a[1])`, RunError: fmt.Errorf("index out of range"), Name: ""},
		{Script: `func a() { return "a" }; b()`, RunError: envPkg.NewUndefinedSymbolErr("b"), Name: ""},
		{Script: ` func a() { return "a" }; 1++()`, RunError: fmt.Errorf("invalid operation"), Name: ""},
		{Script: ` func a(b) { return b }; a(1++)`, RunError: fmt.Errorf("invalid operation"), Name: ""},

		{Script: `a`, Input: map[string]any{"a": testVarFunc}, RunOutput: testVarFunc, Output: map[string]any{"a": testVarFunc}, Name: ""},
		{Script: `a()`, Input: map[string]any{"a": testVarFunc}, RunOutput: int64(1), Output: map[string]any{"a": testVarFunc}, Name: ""},
		{Script: `a`, Input: map[string]any{"a": testVarFuncP}, RunOutput: testVarFuncP, Output: map[string]any{"a": testVarFuncP}, Name: ""},
		// TOFIX:
		// {Script: `a()`, Input: map[string]any{"a": testVarFuncP}, RunOutput: int64(1), Output: map[string]any{"a": testVarFuncP}, Name: ""},

		{Script: `module a { func b() { return } }; a.b()`, RunOutput: nil, Name: ""},
		{Script: `module a { func b() { return nil} }; a.b()`, RunOutput: nil, Name: ""},
		{Script: `module a { func b() { return true} }; a.b()`, RunOutput: true, Name: ""},
		{Script: `module a { func b() { return 1} }; a.b()`, RunOutput: int64(1), Name: ""},
		{Script: `module a { func b() { return 1.1} }; a.b()`, RunOutput: float64(1.1), Name: ""},
		{Script: `module a { func b() { return "a"} }; a.b()`, RunOutput: "a", Name: ""},

		{Script: `if true { module a { func b() { return } } }; a.b()`, RunOutput: nil, Name: ""},
		{Script: `if true { module a { func b() { return nil} } }; a.b()`, RunOutput: nil, Name: ""},
		{Script: `if true { module a { func b() { return true} } }; a.b()`, RunOutput: true, Name: ""},
		{Script: `if true { module a { func b() { return 1} } }; a.b()`, RunOutput: int64(1), Name: ""},
		{Script: `if true { module a { func b() { return 1.1} } }; a.b()`, RunOutput: float64(1.1), Name: ""},
		{Script: `if true { module a { func b() { return "a"} } }; a.b()`, RunOutput: "a", Name: ""},

		{Script: `if true { module a { func b() { return 1} } }; a.b()`, RunOutput: int64(1), Name: ""},

		{Script: `a = 1; func b() { a = 2 }; b()`, RunOutput: int64(2), Output: map[string]any{"a": int64(2)}, Name: ""},
		{Script: `b(a); a`, Input: map[string]any{"a": int64(1), "b": func(c any) { c = int64(2); _ = c }}, RunOutput: int64(1), Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `func b() { }; go b()`, RunOutput: nil, Name: ""},

		{Script: `b(a)`, Input: map[string]any{"a": nil, "b": func(c any) bool { return c == nil }}, RunOutput: true, Output: map[string]any{"a": nil}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": true, "b": func(c bool) bool { return c == true }}, RunOutput: true, Output: map[string]any{"a": true}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": int32(1), "b": func(c int32) bool { return c == 1 }}, RunOutput: true, Output: map[string]any{"a": int32(1)}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": int64(1), "b": func(c int64) bool { return c == 1 }}, RunOutput: true, Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": float32(1.1), "b": func(c float32) bool { return c == 1.1 }}, RunOutput: true, Output: map[string]any{"a": float32(1.1)}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": float64(1.1), "b": func(c float64) bool { return c == 1.1 }}, RunOutput: true, Output: map[string]any{"a": float64(1.1)}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": "a", "b": func(c string) bool { return c == "a" }}, RunOutput: true, Output: map[string]any{"a": "a"}, Name: ""},

		{Script: `b(a)`, Input: map[string]any{"a": testVarValueBool, "b": func(c reflect.Value) bool { return c == testVarValueBool }}, RunOutput: true, Output: map[string]any{"a": testVarValueBool}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": testVarValueInt32, "b": func(c reflect.Value) bool { return c == testVarValueInt32 }}, RunOutput: true, Output: map[string]any{"a": testVarValueInt32}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": testVarValueInt64, "b": func(c reflect.Value) bool { return c == testVarValueInt64 }}, RunOutput: true, Output: map[string]any{"a": testVarValueInt64}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": testVarValueFloat32, "b": func(c reflect.Value) bool { return c == testVarValueFloat32 }}, RunOutput: true, Output: map[string]any{"a": testVarValueFloat32}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": testVarValueFloat64, "b": func(c reflect.Value) bool { return c == testVarValueFloat64 }}, RunOutput: true, Output: map[string]any{"a": testVarValueFloat64}, Name: ""},
		{Script: `b(a)`, Input: map[string]any{"a": testVarValueString, "b": func(c reflect.Value) bool { return c == testVarValueString }}, RunOutput: true, Output: map[string]any{"a": testVarValueString}, Name: ""},
		...
		{Script: `x(a, b, c, d, e, f, g)`, Input: map[string]any{"a": nil, "b": true, "c": int32(1), "d": int64(2), "e": float32(1.1), "f": float64(2.2), "g": "g",
			...
			}}, RunOutput: true, Output: map[string]any{"a": nil, "b": true, "c": int32(1), "d": int64(2), "e": float32(1.1), "f": float64(2.2), "g": "g"}, Name: ""},
		{Script: `x(a, b, c, d, e, f, g)`, Input: map[string]any{"a": nil, "b": true, "c": int32(1), "d": int64(2), "e": float32(1.1), "f": float64(2.2), "g": "g",
			"x": func(a any, b bool, c int32, d int64, e float32, f float64, g string) (any, bool, int32, int64, float32, float64, string) {
				return a, b, c, d, e, f, g
			}}, RunOutput: []any{nil, true, int32(1), int64(2), float32(1.1), float64(2.2), "g"}, Output: map[string]any{"a": nil, "b": true, "c": int32(1), "d": int64(2), "e": float32(1.1), "f": float64(2.2), "g": "g"}, Name: ""},

		{Script: `b = a()`, Input: map[string]any{"a": func() (bool, int32, int64, float32, float64, string) { return true, 1, 2, 3.3, 4.4, "5" }}, RunOutput: []any{true, int32(1), int64(2), float32(3.3), float64(4.4), "5"}, Output: map[string]any{"b": []any{true, int32(1), int64(2), float32(3.3), float64(4.4), "5"}}, Name: ""},
		{Script: `b = a(); b`, Input: map[string]any{"a": func() (bool, int32, int64, float32, float64, string) { return true, 1, 2, 3.3, 4.4, "5" }}, RunOutput: []any{true, int32(1), int64(2), float32(3.3), float64(4.4), "5"}, Output: map[string]any{"b": []any{true, int32(1), int64(2), float32(3.3), float64(4.4), "5"}}, Name: ""},
		{Script: `b, c = a(); b`, Input: map[string]any{"a": func() (bool, int32, int64, float32, float64, string) { return true, 1, 2, 3.3, 4.4, "5" }}, RunOutput: true, Output: map[string]any{"b": true, "c": int32(1)}, Name: ""},
		{Script: `b, c, d = a(); b`, Input: map[string]any{"a": func() (bool, int32, int64, float32, float64, string) { return true, 1, 2, 3.3, 4.4, "5" }}, RunOutput: true, Output: map[string]any{"b": true, "c": int32(1), "d": int64(2)}, Name: ""},
		{Script: `b, c, d, e = a(); b`, Input: map[string]any{"a": func() (bool, int32, int64, float32, float64, string) { return true, 1, 2, 3.3, 4.4, "5" }}, RunOutput: true, Output: map[string]any{"b": true, "c": int32(1), "d": int64(2), "e": float32(3.3)}, Name: ""},
		{Script: `b, c, d, e, f = a(); b`, Input: map[string]any{"a": func() (bool, int32, int64, float32, float64, string) { return true, 1, 2, 3.3, 4.4, "5" }}, RunOutput: true, Output: map[string]any{"b": true, "c": int32(1), "d": int64(2), "e": float32(3.3), "f": float64(4.4)}, Name: ""},
		{Script: `b, c, d, e, f, g = a(); b`, Input: map[string]any{"a": func() (bool, int32, int64, float32, float64, string) { return true, 1, 2, 3.3, 4.4, "5" }}, RunOutput: true, Output: map[string]any{"b": true, "c": int32(1), "d": int64(2), "e": float32(3.3), "f": float64(4.4), "g": "5"}, Name: ""},

		{Script: `a = nil; b(a)`, Input: map[string]any{"b": func(c any) bool { return c == nil }}, RunOutput: true, Output: map[string]any{"a": nil}, Name: ""},
		{Script: `a = true; b(a)`, Input: map[string]any{"b": func(c bool) bool { return c == true }}, RunOutput: true, Output: map[string]any{"a": true}, Name: ""},
		{Script: `a = 1; b(a)`, Input: map[string]any{"b": func(c int64) bool { return c == 1 }}, RunOutput: true, Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `a = 1.1; b(a)`, Input: map[string]any{"b": func(c float64) bool { return c == 1.1 }}, RunOutput: true, Output: map[string]any{"a": float64(1.1)}, Name: ""},
		{Script: `a = "a"; b(a)`, Input: map[string]any{"b": func(c string) bool { return c == "a" }}, RunOutput: true, Output: map[string]any{"a": "a"}, Name: ""},

		{Script: `func b(c) { return c == nil }; b(a)`, Input: map[string]any{"a": nil}, RunOutput: true, Output: map[string]any{"a": nil}, Name: ""},
		{Script: `func b(c) { return c == true }; b(a)`, Input: map[string]any{"a": true}, RunOutput: true, Output: map[string]any{"a": true}, Name: ""},
		{Script: `func b(c) { return c == 1 }; b(a)`, Input: map[string]any{"a": int32(1)}, RunOutput: true, Output: map[string]any{"a": int32(1)}, Name: ""},
		{Script: `func b(c) { return c == 1 }; b(a)`, Input: map[string]any{"a": int64(1)}, RunOutput: true, Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `func b(c) { return c == 1.1 }; b(a)`, Input: map[string]any{"a": float32(1.1)}, RunOutput: true, Output: map[string]any{"a": float32(1.1)}, Name: ""},
		{Script: `func b(c) { return c == 1.1 }; b(a)`, Input: map[string]any{"a": float64(1.1)}, RunOutput: true, Output: map[string]any{"a": float64(1.1)}, Name: ""},
		{Script: `func b(c) { return c == "a" }; b(a)`, Input: map[string]any{"a": "a"}, RunOutput: true, Output: map[string]any{"a": "a"}, Name: ""},

		{Script: `a = nil; func b(c) { return c == nil }; b(a)`, RunOutput: true, Output: map[string]any{"a": nil}, Name: ""},
		{Script: `a = true; func b(c) { return c == true }; b(a)`, RunOutput: true, Output: map[string]any{"a": true}, Name: ""},
		{Script: `a = 1; func b(c) { return c == 1 }; b(a)`, Input: map[string]any{"a": int64(1)}, RunOutput: true, Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `a = 1.1; func b(c) { return c == 1.1 }; b(a)`, Input: map[string]any{"a": float64(1.1)}, RunOutput: true, Output: map[string]any{"a": float64(1.1)}, Name: ""},
		{Script: `a = "a"; func b(c) { return c == "a" }; b(a)`, Input: map[string]any{"a": "a"}, RunOutput: true, Output: map[string]any{"a": "a"}, Name: ""},

		{Script: `b(a[0])`, Input: map[string]any{"a": []any{nil}, "b": func(c any) bool { return c == nil }}, RunOutput: true, Output: map[string]any{"a": []any{nil}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{true}, "b": func(c any) bool { return c == true }}, RunOutput: true, Output: map[string]any{"a": []any{true}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{int32(1)}, "b": func(c any) bool { return c == int32(1) }}, RunOutput: true, Output: map[string]any{"a": []any{int32(1)}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{int64(1)}, "b": func(c any) bool { return c == int64(1) }}, RunOutput: true, Output: map[string]any{"a": []any{int64(1)}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{float32(1.1)}, "b": func(c any) bool { return c == float32(1.1) }}, RunOutput: true, Output: map[string]any{"a": []any{float32(1.1)}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{float64(1.1)}, "b": func(c any) bool { return c == float64(1.1) }}, RunOutput: true, Output: map[string]any{"a": []any{float64(1.1)}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{"a"}, "b": func(c any) bool { return c == "a" }}, RunOutput: true, Output: map[string]any{"a": []any{"a"}}, Name: ""},
		...
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{true}, "b": func(c bool) bool { return c == true }}, RunOutput: true, Output: map[string]any{"a": []any{true}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{int32(1)}, "b": func(c int32) bool { return c == int32(1) }}, RunOutput: true, Output: map[string]any{"a": []any{int32(1)}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{int64(1)}, "b": func(c int64) bool { return c == int64(1) }}, RunOutput: true, Output: map[string]any{"a": []any{int64(1)}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{float32(1.1)}, "b": func(c float32) bool { return c == float32(1.1) }}, RunOutput: true, Output: map[string]any{"a": []any{float32(1.1)}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{float64(1.1)}, "b": func(c float64) bool { return c == float64(1.1) }}, RunOutput: true, Output: map[string]any{"a": []any{float64(1.1)}}, Name: ""},
		{Script: `b(a[0])`, Input: map[string]any{"a": []any{"a"}, "b": func(c string) bool { return c == "a" }}, RunOutput: true, Output: map[string]any{"a": []any{"a"}}, Name: ""},

		{Script: `a = [nil]; b(a[0])`, Input: map[string]any{"b": func(c any) bool { return c == nil }}, RunOutput: true, Output: map[string]any{"a": []any{nil}}, Name: ""},
		{Script: `a = [true]; b(a[0])`, Input: map[string]any{"b": func(c bool) bool { return c == true }}, RunOutput: true, Output: map[string]any{"a": []any{true}}, Name: ""},
		{Script: `a = [1]; b(a[0])`, Input: map[string]any{"b": func(c int64) bool { return c == int64(1) }}, RunOutput: true, Output: map[string]any{"a": []any{int64(1)}}, Name: ""},
		{Script: `a = [1.1]; b(a[0])`, Input: map[string]any{"b": func(c float64) bool { return c == float64(1.1) }}, RunOutput: true, Output: map[string]any{"a": []any{float64(1.1)}}, Name: ""},
		{Script: `a = ["a"]; b(a[0])`, Input: map[string]any{"b": func(c string) bool { return c == "a" }}, RunOutput: true, Output: map[string]any{"a": []any{"a"}}, Name: ""},

		{Script: `a = [nil]; func b(c) { c == nil }; b(a[0])`, RunOutput: true, Output: map[string]any{"a": []any{nil}}, Name: ""},
		{Script: `a = [true]; func b(c) { c == true }; b(a[0])`, RunOutput: true, Output: map[string]any{"a": []any{true}}, Name: ""},
		{Script: `a = [1]; func b(c) { c == 1 }; b(a[0])`, RunOutput: true, Output: map[string]any{"a": []any{int64(1)}}, Name: ""},
		{Script: `a = [1.1]; func b(c) { c == 1.1 }; b(a[0])`, RunOutput: true, Output: map[string]any{"a": []any{float64(1.1)}}, Name: ""},
		{Script: `a = ["a"]; func b(c) { c == "a" }; b(a[0])`, RunOutput: true, Output: map[string]any{"a": []any{"a"}}, Name: ""},

		{Script: `a = nil; b = func (d) { return d == nil }; b(a)`, RunOutput: true, Output: map[string]any{"a": nil}, Name: ""},
		{Script: `a = true; b = func (d) { return d == true }; b(a)`, RunOutput: true, Output: map[string]any{"a": true}, Name: ""},
		{Script: `a = 1; b = func (d) { return d == 1 }; b(a)`, RunOutput: true, Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `a = 1.1; b = func (d) { return d == 1.1 }; b(a)`, RunOutput: true, Output: map[string]any{"a": float64(1.1)}, Name: ""},
		{Script: `a = "a"; b = func (d) { return d == "a" }; b(a)`, RunOutput: true, Output: map[string]any{"a": "a"}, Name: ""},

		{Script: `a = nil; b = func c(d) { return d == nil }; b(a)`, RunOutput: true, Output: map[string]any{"a": nil}, Name: ""},
		{Script: `a = true; b = func c(d) { return d == true }; b(a)`, RunOutput: true, Output: map[string]any{"a": true}, Name: ""},
		{Script: `a = 1; b = func c(d) { return d == 1 }; b(a)`, RunOutput: true, Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `a = 1.1; b = func c(d) { return d == 1.1 }; b(a)`, RunOutput: true, Output: map[string]any{"a": float64(1.1)}, Name: ""},
		{Script: `a = "a"; b = func c(d) { return d == "a" }; b(a)`, RunOutput: true, Output: map[string]any{"a": "a"}, Name: ""},

		{Script: `a = nil; b = func c(d) { return d == nil }; c(a)`, RunOutput: true, Output: map[string]any{"a": nil}, Name: ""},
		{Script: `a = true; b = func c(d) { return d == true }; c(a)`, RunOutput: true, Output: map[string]any{"a": true}, Name: ""},
		{Script: `a = 1; b = func c(d) { return d == 1 }; c(a)`, RunOutput: true, Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `a = 1.1; b = func c(d) { return d == 1.1 }; c(a)`, RunOutput: true, Output: map[string]any{"a": float64(1.1)}, Name: ""},
		{Script: `a = "a"; b = func c(d) { return d == "a" }; c(a)`, RunOutput: true, Output: map[string]any{"a": "a"}, Name: ""},

		{Script: `a = nil; func b() { return func c(d) { d == nil } }; e = b(); e(a)`, RunOutput: true, Output: map[string]any{"a": nil}, Name: ""},
		{Script: `a = true; func b() { return func c(d) { d == true } }; e = b(); e(a)`, RunOutput: true, Output: map[string]any{"a": true}, Name: ""},
		{Script: `a = 1; func b() { return func c(d) { d == 1 } }; e = b(); e(a)`, RunOutput: true, Output: map[string]any{"a": int64(1)}, Name: ""},
		{Script: `a = 1.1; func b() { return func c(d) { d == 1.1 } }; e = b(); e(a)`, RunOutput: true, Output: map[string]any{"a": float64(1.1)}, Name: ""},
		{Script: `a = "a"; func b() { return func c(d) { d == "a" } }; e = b(); e(a)`, RunOutput: true, Output: map[string]any{"a": "a"}, Name: ""},

		{Script: `a = func () { return nil }; func b(c) { return c() }; b(a)`, RunOutput: nil, Name: ""},
		{Script: `a = func () { return true }; func b(c) { return c() }; b(a)`, RunOutput: true, Name: ""},
		{Script: `a = func () { return 1 }; func b(c) { return c() }; b(a)`, RunOutput: int64(1), Name: ""},
		{Script: `a = func () { return 1.1 }; func b(c) { return c() }; b(a)`, RunOutput: float64(1.1), Name: ""},
		{Script: `a = func () { return "a" }; func b(c) { return c() }; b(a)`, RunOutput: "a", Name: ""},

		{Script: `a = [nil]; func c(d) { return d[0] }; c(a)`, RunOutput: nil, Name: ""},
		{Script: `a = [true]; func c(d) { return d[0] }; c(a)`, RunOutput: true, Name: ""},
		{Script: `a = [1]; func c(d) { return d[0] }; c(a)`, RunOutput: int64(1), Name: ""},
		{Script: `a = [1.1]; func c(d) { return d[0] }; c(a)`, RunOutput: float64(1.1), Name: ""},
		{Script: `a = ["a"]; func c(d) { return d[0] }; c(a)`, RunOutput: "a", Name: ""},

		{Script: `a = {"b": nil}; func c(d) { return d.b }; c(a)`, RunOutput: nil, Name: ""},
		{Script: `a = {"b": true}; func c(d) { return d.b }; c(a)`, RunOutput: true, Name: ""},
		{Script: `a = {"b": 1}; func c(d) { return d.b }; c(a)`, RunOutput: int64(1), Name: ""},
		{Script: `a = {"b": 1.1}; func c(d) { return d.b }; c(a)`, RunOutput: float64(1.1), Name: ""},
		{Script: `a = {"b": "a"}; func c(d) { return d.b }; c(a)`, RunOutput: "a", Name: ""},

		{Script: `a = func() { return func(c) { return c + "c"} }; a()("a")`, RunOutput: "ac", Name: ""},
		{Script: `a = func() { return func(c) { return c + "c"} }(); a("a")`, RunOutput: "ac", Name: ""},
		{Script: `a = func() { return func(c) { return c + "c"} }()("a")`, RunOutput: "ac", Name: ""},
		{Script: `func() { return func(c) { return c + "c"} }()("a")`, RunOutput: "ac", Name: ""},

		{Script: `a = func(b) { return func() { return b + "c"} }; b = a("a"); b()`, RunOutput: "ac", Name: ""},
		{Script: `a = func(b) { return func() { return b + "c"} }("a"); a()`, RunOutput: "ac", Name: ""},
		{Script: `a = func(b) { return func() { return b + "c"} }("a")()`, RunOutput: "ac", Name: ""},
		{Script: `func(b) { return func() { return b + "c"} }("a")()`, RunOutput: "ac", Name: ""},

		{Script: `a = func(b) { return func(c) { return b[c] } }; b = a({"x": "x"}); b("x")`, RunOutput: "x", Name: ""},
		{Script: `a = func(b) { return func(c) { return b[c] } }({"x": "x"}); a("x")`, RunOutput: "x", Name: ""},
		{Script: `a = func(b) { return func(c) { return b[c] } }({"x": "x"})("x")`, RunOutput: "x", Name: ""},
		{Script: `func(b) { return func(c) { return b[c] } }({"x": "x"})("x")`, RunOutput: "x", Name: ""},

		{Script: `a = func(b) { return func(c) { return b[c] } }; x = {"y": "y"}; b = a(x); x = {"y": "y"}; b("y")`, RunOutput: "y", Name: ""},
		{Script: `a = func(b) { return func(c) { return b[c] } }; x = {"y": "y"}; b = a(x); x.y = "z"; b("y")`, RunOutput: "z", Name: ""},

		{Script: ` func a() { return "a" }; a()`, RunOutput: "a", Name: ""},
		{Script: `a = func a() { return "a" }; a = func() { return "b" }; a()`, RunOutput: "b", Name: ""},
		{Script: `a = "a.b"; func a() { return "a" }; a()`, RunOutput: "a", Name: ""},

		{Script: `a = func() { b = "b"; return func() { b += "c" } }(); a()`, RunOutput: "bc", Name: ""},
		{Script: `a = func() { b = "b"; return func() { b += "c"; return b} }(); a()`, RunOutput: "bc", Name: ""},
		{Script: `a = func(b) { return func(c) { return func(d) { return d + "d" }(c) + "c" }(b) + "b" }("a")`, RunOutput: "adcb", Name: ""},
		{Script: `a = func(b) { return "b" + func(c) { return "c" + func(d) { return "d" + d  }(c) }(b) }("a")`, RunOutput: "bcda", Name: ""},
		{Script: `a = func(b) { return b + "b" }; a( func(c) { return c + "c" }("a") )`, RunOutput: "acb", Name: ""},

		{Script: `a = func(x, y) { return func() { x(y) } }; b = a(func (z) { return z + "z" }, "b"); b()`, RunOutput: "bz", Name: ""},

		{Script: `a = make(Time); a.IsZero()`, Types: map[string]any{"Time": time.Time{}}, RunOutput: true, Name: ""},

		{Script: `a = make(Buffer); n, err = a.WriteString("a"); if err != nil { return err }; n`, Types: map[string]any{"Buffer": bytes.Buffer{}}, RunOutput: 1, Name: ""},
		{Script: `a = make(Buffer); n, err = a.WriteString("a"); if err != nil { return err }; a.String()`, Types: map[string]any{"Buffer": bytes.Buffer{}}, RunOutput: "a", Name: ""},
...
func TestVariadicFunctions(t *testing.T) {
	...
	tests := []Test{
		...
		{Script: `func a(b...) { return b }; a()`, RunOutput: []any{}, Name: ""},
		{Script: `func a(b...) { return b }; a(true)`, RunOutput: []any{true}, Name: ""},
		{Script: `func a(b...) { return b }; a(true, true)`, RunOutput: []any{true, true}, Name: ""},
		{Script: `func a(b...) { return b }; a([true])`, RunOutput: []any{[]any{true}}, Name: ""},
		{Script: `func a(b...) { return b }; a([true, true])`, RunOutput: []any{[]any{true, true}}, Name: ""},
		{Script: `func a(b...) { return b }; a([true, true], [true, true])`, RunOutput: []any{[]any{true, true}, []any{true, true}}, Name: ""},

		// params Variadic arg !Variadic
		{Script: `func a(b, c...) { return c }; a()`, RunError: fmt.Errorf("function wants 2 arguments but received 0"), Name: ""},
		{Script: `func a(b, c...) { return c }; a(true)`, RunOutput: []any{}, Name: ""},
		{Script: `func a(b, c...) { return c }; a(true, true)`, RunOutput: []any{true}, Name: ""},
		{Script: `func a(b, c...) { return c }; a(true, true, true)`, RunOutput: []any{true, true}, Name: ""},
		{Script: `func a(b, c...) { return c }; a([true])`, RunOutput: []any{}, Name: ""},
		{Script: `func a(b, c...) { return c }; a([true], [true])`, RunOutput: []any{[]any{true}}, Name: ""},
		{Script: `func a(b, c...) { return c }; a([true], [true], [true])`, RunOutput: []any{[]any{true}, []any{true}}, Name: ""},
		{Script: `func a(b, c...) { return c }; a([true], [true, true], [true, true])`, RunOutput: []any{[]any{true, true}, []any{true, true}}, Name: ""},

		// params Variadic arg Variadic
		{Script: `func a(b...) { return b }; a([true]...)`, RunOutput: []any{true}, Name: ""},
		{Script: `func a(b...) { return b }; a([true, true]...)`, RunOutput: []any{true, true}, Name: ""},
		{Script: `func a(b...) { return b }; a(true, [true]...)`, RunError: fmt.Errorf("function wants 1 arguments but received 2"), Name: ""},

		// params Variadic arg Variadic
		{Script: `func a(b, c...) { return c }; a([true]...)`, RunOutput: []any{}, Name: ""},
		{Script: `func a(b, c...) { return c }; a([true, true]...)`, RunOutput: []any{}, Name: ""},
		{Script: `func a(b, c...) { return c }; a(true, [true]...)`, RunOutput: []any{true}, Name: ""},
		{Script: `func a(b, c...) { return c }; a(true, [true, true]...)`, RunOutput: []any{true, true}, Name: ""},

		// params !Variadic arg Variadic
		{Script: `func a() { return "a" }; a([true]...)`, RunOutput: "a", Name: ""},
		{Script: `func a() { return "a" }; a(true, [true]...)`, RunOutput: "a", Name: ""},
		{Script: `func a() { return "a" }; a(true, [true, true]...)`, RunOutput: "a", Name: ""},

		// params !Variadic arg Variadic
		{Script: `func a(b) { return b }; a(true...)`, RunError: fmt.Errorf("call is variadic but last parameter is of type bool"), Name: ""},
		{Script: `func a(b) { return b }; a([true]...)`, RunOutput: true, Name: ""},
		{Script: `func a(b) { return b }; a(true, false...)`, RunError: fmt.Errorf("function wants 1 arguments but received 2"), Name: ""},
		{Script: `func a(b) { return b }; a(true, [1]...)`, RunError: fmt.Errorf("function wants 1 arguments but received 2"), Name: ""},
		{Script: `func a(b) { return b }; a(true, [1, 2]...)`, RunError: fmt.Errorf("function wants 1 arguments but received 2"), Name: ""},
		{Script: `func a(b) { return b }; a([true, 1]...)`, RunOutput: true, Name: ""},
		{Script: `func a(b) { return b }; a([true, 1, 2]...)`, RunOutput: true, Name: ""},

		// params !Variadic arg Variadi
		{Script: `func a(b, c) { return c }; a(false...)`, RunError: fmt.Errorf("call is variadic but last parameter is of type bool"), Name: ""},
		{Script: `func a(b, c) { return c }; a([1]...)`, RunError: fmt.Errorf("function wants 2 arguments but received 1"), Name: ""},
		{Script: `func a(b, c) { return c }; a(1, true...)`, RunError: fmt.Errorf("call is variadic but last parameter is of type bool"), Name: ""},
		{Script: `func a(b, c) { return c }; a(1, [true]...)`, RunOutput: true, Name: ""},
		{Script: `func a(b, c) { return c }; a([1, true]...)`, RunOutput: true, Name: ""},
		{Script: `func a(b, c) { return c }; a(1, true...)`, RunError: fmt.Errorf("call is variadic but last parameter is of type bool"), Name: ""},
		{Script: `func a(b, c) { return c }; a(1, [true]...)`, RunOutput: true, Name: ""},
		{Script: `func a(b, c) { return c }; a(1, true, false...)`, RunError: fmt.Errorf("function wants 2 arguments but received 3"), Name: ""},
		{Script: `func a(b, c) { return c }; a(1, true, [2]...)`, RunError: fmt.Errorf("function wants 2 arguments but received 3"), Name: ""},
		{Script: `func a(b, c) { return c }; a(1, [true, 2]...)`, RunOutput: true, Name: ""},
		{Script: `func a(b, c) { return c }; a([1, true, 2]...)`, RunOutput: true, Name: ""},
	}
	for _, tt := range tests {
		t.Run(tt.Name, func(t *testing.T) { runTest(t, tt, nil) })
