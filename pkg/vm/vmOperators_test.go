...
func TestSwitch(t *testing.T) {
	...
	tests := []Test{
		...
		{Script: `a = 1; switch a {}`, RunOutput: int64(1), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 1; switch a {case: return 2}`, RunOutput: int64(1), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 1; switch a {case: return 2; case: return 3}`, RunOutput: int64(1), Output: map[string]any{"a": int64(1)}},

		// test 1 case
		{Script: `a = 1; switch a {case 1: return 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: return 5}`, RunOutput: int64(2), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 1; switch a {case 1,2: return 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1,2: return 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1,2: return 5}`, RunOutput: int64(3), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 1; switch a {case 1,2,3: return 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1,2,3: return 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1,2,3: return 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 4; switch a {case 1,2,3: return 5}`, RunOutput: int64(4), Output: map[string]any{"a": int64(4)}},
		...
		{Script: `a = func() { return 5 }; b = 1; switch b {case 1: return a() }`, RunOutput: int64(5), Output: map[string]any{"b": int64(1)}},
		{Script: `a = func() { return 6 }; b = 2; switch b {case 1: return a() }`, RunOutput: int64(2), Output: map[string]any{"b": int64(2)}},

		// test 2 cases
		{Script: `a = 1; switch a {case 1: return 5; case 2: return 6}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: return 5; case 2: return 6}`, RunOutput: int64(6), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1: return 5; case 2: return 6}`, RunOutput: int64(3), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 1; switch a {case 1: return 5; case 2,3: return 6}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: return 5; case 2,3: return 6}`, RunOutput: int64(6), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1: return 5; case 2,3: return 6}`, RunOutput: int64(6), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 4; switch a {case 1: return 5; case 2,3: return 6}`, RunOutput: int64(4), Output: map[string]any{"a": int64(4)}},

		// test 3 cases
		{Script: `a = 1; switch a {case 1,2: return 5; case 3: return 6}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1,2: return 5; case 3: return 6}`, RunOutput: int64(5), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1,2: return 5; case 3: return 6}`, RunOutput: int64(6), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 4; switch a {case 1,2: return 5; case 3: return 6}`, RunOutput: int64(4), Output: map[string]any{"a": int64(4)}},
		{Script: `a = 1; switch a {case 1,2: return 5; case 2,3: return 6}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1,2: return 5; case 2,3: return 6}`, RunOutput: int64(5), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1,2: return 5; case 2,3: return 6}`, RunOutput: int64(6), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 4; switch a {case 1,2: return 5; case 2,3: return 6}`, RunOutput: int64(4), Output: map[string]any{"a": int64(4)}},

		// test default
		{Script: `a = 1; switch a {default: return 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 1; switch a {case 1: return 5; case 2: return 6; default: return 7}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: return 5; case 2: return 6; default: return 7}`, RunOutput: int64(6), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1: return 5; case 2: return 6; default: return 7}`, RunOutput: int64(7), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 1; switch a {case 1: return 5; case 2,3: return 6; default: return 7}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: return 5; case 2,3: return 6; default: return 7}`, RunOutput: int64(6), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1: return 5; case 2,3: return 6; default: return 7}`, RunOutput: int64(6), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 4; switch a {case 1: return 5; case 2,3: return 6; default: return 7}`, RunOutput: int64(7), Output: map[string]any{"a": int64(4)}},
		{Script: `a = 1; switch a {case 1,2: return 5; case 3: return 6; default: return 7}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1,2: return 5; case 3: return 6; default: return 7}`, RunOutput: int64(5), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 3; switch a {case 1,2: return 5; case 3: return 6; default: return 7}`, RunOutput: int64(6), Output: map[string]any{"a": int64(3)}},
		{Script: `a = 4; switch a {case 1,2: return 5; case 3: return 6; default: return 7}`, RunOutput: int64(7), Output: map[string]any{"a": int64(4)}},

		// test scope
		{Script: `a = 1; switch a {case 1: a = 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(5)}},
		{Script: `a = 2; switch a {case 1: a = 5}`, RunOutput: int64(2), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 1; b = 5; switch a {case 1: b = 6}`, RunOutput: int64(6), Output: map[string]any{"a": int64(1), "b": int64(6)}},
		{Script: `a = 2; b = 5; switch a {case 1: b = 6}`, RunOutput: int64(2), Output: map[string]any{"a": int64(2), "b": int64(5)}},
		{Script: `a = 1; b = 5; switch a {case 1: b = 6; default: b = 7}`, RunOutput: int64(6), Output: map[string]any{"a": int64(1), "b": int64(6)}},
		{Script: `a = 2; b = 5; switch a {case 1: b = 6; default: b = 7}`, RunOutput: int64(7), Output: map[string]any{"a": int64(2), "b": int64(7)}},

		// test scope without define b
		{Script: `a = 1; switch a {case 1: b = 5}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: b = 5}`, RunOutput: int64(2), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 1; switch a {case 1: b = 5}; b`, RunError: fmt.Errorf("undefined symbol 'b'"), RunOutput: nil, Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: b = 5}; b`, RunError: fmt.Errorf("undefined symbol 'b'"), RunOutput: nil, Output: map[string]any{"a": int64(2)}},
		{Script: `a = 1; switch a {case 1: b = 5; default: b = 6}`, RunOutput: int64(5), Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: b = 5; default: b = 6}`, RunOutput: int64(6), Output: map[string]any{"a": int64(2)}},
		{Script: `a = 1; switch a {case 1: b = 5; default: b = 6}; b`, RunError: fmt.Errorf("undefined symbol 'b'"), RunOutput: nil, Output: map[string]any{"a": int64(1)}},
		{Script: `a = 2; switch a {case 1: b = 5; default: b = 6}; b`, RunError: fmt.Errorf("undefined symbol 'b'"), RunOutput: nil, Output: map[string]any{"a": int64(2)}},
...
func TestItemInList(t *testing.T) {
	...
	tests := []Test{
		...
		{Script: `"a" in l`, Input: map[string]any{"l": []any{"a"}}, RunOutput: true},
		{Script: `"a" in l`, Input: map[string]any{"l": []any{"b"}}, RunOutput: false},
		{Script: `"a" in l`, Input: map[string]any{"l": []any{"c", "b", "a"}}, RunOutput: true},
		{Script: `"a" in l`, Input: map[string]any{"l": []any{"a", "b", 1}}, RunOutput: true},

		{Script: `1 in [1]`, RunOutput: true},
		{Script: `1 in [2]`, RunOutput: false},
		{Script: `1 in [3, 2, 1]`, RunOutput: true},
		{Script: `1 in ["1"]`, RunOutput: true},
		{Script: `1 in l`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `"1" in l`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `1 in l`, Input: map[string]any{"l": []any{2}}, RunOutput: false},
		{Script: `1 in l`, Input: map[string]any{"l": []any{3, 2, 1}}, RunOutput: true},
		{Script: `1 in l`, Input: map[string]any{"l": []any{"1"}}, RunOutput: true},

		{Script: `0.9 in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: false},
		{Script: `1.0 in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `1.1 in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: false},
		{Script: `1 in [0.9]`, Input: map[string]any{"l": []any{0.9}}, RunOutput: false},
		{Script: `1 in [1.0]`, Input: map[string]any{"l": []any{1.0}}, RunOutput: true},
		{Script: `1 in [1.1]`, Input: map[string]any{"l": []any{1.1}}, RunOutput: false},
		{Script: `0.9 in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: false},
		{Script: `1.0 in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `1.1 in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: false},
		{Script: `1 in [0.9]`, Input: map[string]any{"l": []any{0.9}}, RunOutput: false},
		...
		{Script: `true in l`, Input: map[string]any{"l": []any{"true"}}, RunOutput: true},
		{Script: `true in l`, Input: map[string]any{"l": []any{true}}, RunOutput: true},
		{Script: `true in l`, Input: map[string]any{"l": []any{true, false}}, RunOutput: true},
		{Script: `false in l`, Input: map[string]any{"l": []any{false, true}}, RunOutput: true},
		...
		{Script: `"a" in l[1:]`, Input: map[string]any{"l": []any{"b", "a", "c"}}, RunOutput: true},
		{Script: `"a" in l[:1]`, Input: map[string]any{"l": []any{"b", "a", "c"}}, RunOutput: false},
		{Script: `"a" in l[1:2]`, Input: map[string]any{"l": []any{"b", "a", "c"}}, RunOutput: true},

		// for i in list && item in list
		{Script: `list_of_list = [["a"]];for l in list_of_list { return "a" in l }`, RunOutput: true},
		{Script: `for l in list_of_list { return "a" in l }`, Input: map[string]any{"list_of_list": []any{[]any{"a"}}}, RunOutput: true},
		...
		{Script: `switch 1 in l {case true: return true;default: return false}`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `switch 1 in l {case true: return true;default: return false}`, Input: map[string]any{"l": []any{2, 3}}, RunOutput: false},
		{Script: `switch true {case 1 in l: return true;default: return false}`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `switch false {case 1 in l: return true;default: return false}`, Input: map[string]any{"l": []any{1}}, RunOutput: false},
		{Script: `if 1 in l {return true} else {return false}`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `if 1 in l {return true} else {return false}`, Input: map[string]any{"l": []any{2, 3}}, RunOutput: false},
		{Script: `for i in l { i++ }`, Input: map[string]any{"l": []any{1, 2, 3}}},
		{Script: `a=1; a=a in l`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `a=1; a=a in l`, Input: map[string]any{"l": []any{2, 3}}, RunOutput: false},
		{Script: `1 in l && true`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `1 in l && false`, Input: map[string]any{"l": []any{1}}, RunOutput: false},
		{Script: `1 in l || true`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `1 in l || false`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `1 in l && true`, Input: map[string]any{"l": []any{2, 3}}, RunOutput: false},
		{Script: `1 in l && false`, Input: map[string]any{"l": []any{2, 3}}, RunOutput: false},
		{Script: `1 in l || true`, Input: map[string]any{"l": []any{2, 3}}, RunOutput: true},
		{Script: `1 in l || false`, Input: map[string]any{"l": []any{2, 3}}, RunOutput: false},
		{Script: `1++ in l`, Input: map[string]any{"l": []any{1, 2, 3}}, RunError: fmt.Errorf("invalid operation")},
		{Script: `3++ in l`, Input: map[string]any{"l": []any{1, 2, 3}}, RunError: fmt.Errorf("invalid operation")},
		{Script: `a=1;a++ in l`, Input: map[string]any{"l": []any{1, 2, 3}}, RunOutput: true},
		{Script: `a=3;a++ in l`, Input: map[string]any{"l": []any{1, 2, 3}}, RunOutput: false},
		...
		{Script: `[[1]] in [[1]]`, RunOutput: false},
		{Script: `[[1]] in [[[1]]]`, RunOutput: true},
		{Script: `1 in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: true},
		{Script: `1 in [[1]]`, Input: map[string]any{"l": []any{[]any{1}}}, RunOutput: false},
		{Script: `1 in [[[1]]]`, Input: map[string]any{"l": []any{[]any{[]any{1}}}}, RunOutput: false},
		{Script: `1 in [[1],[[1]],1]`, Input: map[string]any{"l": []any{[]any{1}, []any{[]any{1}}, 1}}, RunOutput: true},
		{Script: `[1] in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: false},
		{Script: `[1] in [[1]]`, Input: map[string]any{"l": []any{[]any{1}}}, RunOutput: true},
		{Script: `[1] in [[[1]]]`, Input: map[string]any{"l": []any{[]any{[]any{1}}}}, RunOutput: false},
		{Script: `[[1]] in [1]`, Input: map[string]any{"l": []any{1}}, RunOutput: false},
		{Script: `[[1]] in [[1]]`, Input: map[string]any{"l": []any{[]any{1}}}, RunOutput: false},
