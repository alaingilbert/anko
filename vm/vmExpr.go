...
func (runInfo *runInfoStruct) invokeExpr() {
	...
	case *ast.OpExpr:
		runInfo.invokeOpExpr(expr)
	case *ast.IdentExpr:
		runInfo.invokeIdentExpr(expr)
	case *ast.LiteralExpr:
		runInfo.invokeLiteralExpr(expr)
	case *ast.ArrayExpr:
	...
	case *ast.FuncExpr:
		runInfo.invokeFuncExpr(expr)
	case *ast.AnonCallExpr:
		runInfo.invokeAnonCallExpr(expr)
	case *ast.CallExpr:
		runInfo.invokeCallExpr(expr)
	case *ast.IncludeExpr:
		runInfo.invokeIncludeExpr(expr)
	default:
		runInfo.invokeDefault(expr)
	}
}

func (runInfo *runInfoStruct) invokeOpExpr(expr *ast.OpExpr) {
	runInfo.operator = expr.Op
	runInfo.invokeOperator()
}

func (runInfo *runInfoStruct) invokeIdentExpr(expr *ast.IdentExpr) {
...
func (runInfo *runInfoStruct) invokeLiteralExpr(expr *ast.LiteralExpr) {
...
func (runInfo *runInfoStruct) invokeParenExpr(expr *ast.ParenExpr) {
...
func (runInfo *runInfoStruct) invokeFuncExpr(expr *ast.FuncExpr) {
	runInfo.expr = expr
	runInfo.funcExpr()
}

func (runInfo *runInfoStruct) invokeAnonCallExpr(expr *ast.AnonCallExpr) {
	runInfo.expr = expr
	runInfo.anonCallExpr()
}

func (runInfo *runInfoStruct) invokeCallExpr(expr *ast.CallExpr) {
	runInfo.expr = expr
	runInfo.callExpr()
}
...
func (runInfo *runInfoStruct) invokeDefault(expr ast.Expr) {
